...
(function (window, factory) {
  ...
  Tour = (function () {
        ...
        return function (e) {
          ...
          if (step.reflex) {
            $(step.reflexElement)
              ...
              .off(
                "" +
                  _this._reflexEvent(step.reflex) +
                  ".tour-" +
                  _this._options.name
              );
          }
    ...
    Tour.prototype.showStep = function (i) {
      ...
      if (
        step.redirect &&
        this._isRedirect(step.host, path, document.location)
      ) {
        this._redirect(step, i, path);
        if (
          !this._isJustPathHashDifferent(step.host, path, document.location)
        ) {
          return;
        }
      }
    ...
    Tour.prototype._isRedirect = function (host, path, location) {
      ...
      if (
        host != null &&
        host !== "" &&
        (({}.toString.call(host) === "[object RegExp]" &&
          !host.test(location.origin)) ||
          ({}.toString.call(host) === "[object String]" &&
            this._isHostDifferent(host, location)))
      ) {
        return true;
      }
      ...
      return (
        ...
        (({}.toString.call(path) === "[object RegExp]" &&
          ...
          ({}.toString.call(path) === "[object String]" &&
            this._isPathDifferent(path, currentPath)))
      );
    };
    ...
    Tour.prototype._isHostDifferent = function (host, location) {
      switch ({}.toString.call(host)) {
        ...
        case "[object String]":
          return (
            this._getProtocol(host) !== this._getProtocol(location.href) ||
            this._getHost(host) !== this._getHost(location.href)
          );
        default:
          return true;
      }
    ...
    Tour.prototype._isPathDifferent = function (path, currentPath) {
      return (
        this._getPath(path) !== this._getPath(currentPath) ||
        !this._equal(this._getQuery(path), this._getQuery(currentPath)) ||
        !this._equal(this._getHash(path), this._getHash(currentPath))
      );
    };
    ...
    Tour.prototype._redirect = function (step, i, path) {
      ...
      if ($.isFunction(step.redirect)) {
        ...
        href =
          {}.toString.call(step.host) === "[object String]"
            ? "" + step.host + path
            : path;
    ...
    Tour.prototype._showPopover = function (step, i) {
      ...
      shouldAddSmart =
        step.smartPlacement === true && step.placement.search(/auto/i) === -1;
      $element
        .popover({
    ...
    Tour.prototype._showOverlayElement = function (step, force) {
      ...
      if (
        !$element ||
        $element.length === 0 ||
        (this.backdrop.overlayElementShown && !force)
      ) {
        return;
      }
      ...
      if (step.backdropPadding) {
        elementData = this._applyBackdropPadding(
          step.backdropPadding,
          elementData
        );
      }
      return this.backdrop.$background
